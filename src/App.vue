...
<script type="text/javascript">
  import { QLayout, QToolbar, QToolbarTitle, QBtn, QIcon, QTransition, QInnerLoading } from 'quasar'
  ...
  export default {
    ...
    components: {
      QLayout, QToolbar, QToolbarTitle, QBtn, QIcon, QTransition, QInnerLoading, Drawer, ContentHeader, UserMenu, MessagePopover
    },
    mounted () {
      this.getPosts()
    },
...
<style lang="stylus">
  ...
  .q-card, .layout-aside.fixed.on-layout
    box-shadow 0 2px 8px rgba(59, 89, 178, 0.2)
